  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          backgroundImage: headerBackground?.background_image_url ? `url(${headerBackground.background_image_url})` : 'none',
          backgroundColor: headerBackground?.background_color_hex || '#059669',
      ...
      >
        {/* Glassy Overlay */}
        {headerBackground?.background_image_url && (
          ...
          {showHeaderText && !isHeaderSticky && (
            <div className="text-center mb-4">
              <h1
                ...
                style={{
                  color: headerBackground?.background_image_url ? 'white' : 'white',
